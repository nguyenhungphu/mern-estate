    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4' action="">
          <div className='flex flex-col gap-4 flex-1'>
            <input type="text" placeholder='Name' name="Name" id="name" className='border p-3 rounded-lg' maxLength='62' minLength='10' required/>
            <input type="text" placeholder='Description' name="Description" id="description" className='border p-3 rounded-lg' required/>
